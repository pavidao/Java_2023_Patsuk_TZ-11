...
class DogVideo {
    ...
    private int likes;
    private int dislikes;
    private List<DogComment> comments;

    public DogVideo(String title, String url, int views, int likes, int dislikes, List<DogComment> comments) {
        this.title = title;
        this.url = url;
        this.views = views;
        this.likes = likes;
    ...
    public List<DogComment> getComments() {
        return comments;
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        List<DogComment> comments1 = Arrays.asList(new DogComment("Cute dog!", 60, 2),
        ...
        List<DogComment> comments2 = Arrays.asList(new DogComment("I love this breed!", 5, 10),
